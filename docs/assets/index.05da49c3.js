import{d as h,r as _,a as o,o as B,c as C,b as t,w as i,_ as F,f as w,t as y,e as g,k as E,l as k,F as D,i as b,u as O,j as q,p as G,h as H}from"./index.7e2ee225.js";function A(u){u.__sourceCode=`<template>
...
<\/script>`,u.__sourceCodeTitle="\u57FA\u672C\u7528\u6CD5"}const J={style:{"line-height":"40px"}},z=h({__name:"BaseDemo",setup(u){const n=_(!1),s=_("\u5355\u51FB\u586B\u5199");function a(p){console.log(p)}function l(){n.value=!1}function d(){l()}function r(p){p.key==="Enter"&&l()}return(p,e)=>{const v=o("el-input"),m=o("fu-read-write-switch");return B(),C("div",J,[t(m,{data:s.value,modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=f=>n.value=f),onChange:a},{default:i(()=>[t(v,{modelValue:s.value,"onUpdate:modelValue":e[0]||(e[0]=f=>s.value=f),onBlur:d,onKeydown:r},null,8,["modelValue"])]),_:1},8,["data","modelValue"])])}}});typeof A=="function"&&A(z);var M=F(z,[["__file","/home/runner/work/fit2cloud-ui-plus/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/BaseDemo.vue"]]);function V(u){u.__sourceCode=`<template>
  <div style="line-height: 40px;">
    <fu-read-write-switch>
      <!-- \u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9 v-slot:read -->
      <template #read>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="InputRwSwitch"}const I=h({__name:"InputRwSwitchDemo",setup(u){const n=_("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("fu-input-rw-switch");return B(),E(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=d=>n.value=d),placeholder:"\u5355\u51FB\u586B\u5199"},null,8,["modelValue"])}}});typeof S=="function"&&S(I);var Y=F(I,[["__file","/home/runner/work/fit2cloud-ui-plus/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/InputRwSwitchDemo.vue"]]);function x(u){u.__sourceCode=`<template>
  <h3>
    v-model + \u4E8B\u4EF6 \u63A7\u5236\u72B6\u6001
  </h3>
  <div style="line-height: 40px;">
