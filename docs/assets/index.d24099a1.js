import{d as F,r as f,a as o,o as B,c as C,b as t,w as i,_ as h,f as w,t as y,e as b,k as E,l as k,F as D,i as g,u as O,j as q,p as G,h as H}from"./index.16f7f1db.js";function A(u){u.__sourceCode=`<template>
...
<\/script>`,u.__sourceCodeTitle="\u57FA\u672C\u7528\u6CD5"}const J={style:{"line-height":"40px"}},z=F({__name:"BaseDemo",setup(u){const n=f(!1),s=f("\u5355\u51FB\u586B\u5199");function a(p){console.log(p)}function l(){n.value=!1}function d(){l()}function r(p){p.key==="Enter"&&l()}return(p,e)=>{const v=o("el-input"),m=o("fu-read-write-switch");return B(),C("div",J,[t(m,{data:s.value,modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=_=>n.value=_),onChange:a},{default:i(()=>[t(v,{modelValue:s.value,"onUpdate:modelValue":e[0]||(e[0]=_=>s.value=_),onBlur:d,onKeydown:r},null,8,["modelValue"])]),_:1},8,["data","modelValue"])])}}});typeof A=="function"&&A(z);var M=h(z,[["__file","/home/runner/work/fit2cloud-ui-plus/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/BaseDemo.vue"]]);function V(u){u.__sourceCode=`<template>
  <div style="line-height: 40px;">
    <fu-read-write-switch>
      <!-- \u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9 v-slot:read -->
      <template #read>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="\u81EA\u5B9A\u4E49\u8BFB\u5199\u5185\u5BB9"}const P={style:{"line-height":"40px"}},Q=b(" \u81EA\u5B9A\u4E49\u5199\u5185\u5BB9: "),R=F({__name:"CustomContentDemo",setup(u){const n=f("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("el-input"),d=o("fu-read-write-switch");return B(),C("div",P,[t(d,null,{read:i(()=>[w("div",null,"\u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9: "+y(n.value),1)]),default:i(({read:r})=>[Q,t(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=p=>n.value=p),onBlur:r,style:{width:"200px"}},null,8,["modelValue","onBlur"])]),_:1})])}}});typeof V=="function"&&V(R);var X=h(R,[["__file","/home/runner/work/fit2cloud-ui-plus/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/CustomContentDemo.vue"]]);function S(u){u.__sourceCode=`<template>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="InputRwSwitch"}const I=F({__name:"InputRwSwitchDemo",setup(u){const n=f("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("fu-input-rw-switch");return B(),E(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=d=>n.value=d),placeholder:"\u5355\u51FB\u586B\u5199"},null,8,["modelValue"])}}});typeof S=="function"&&S(I);var Y=h(I,[["__file","/home/runner/work/fit2cloud-ui-plus/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/InputRwSwitchDemo.vue"]]);function x(u){u.__sourceCode=`<template>
  <h3>
    v-model + \u4E8B\u4EF6 \u63A7\u5236\u72B6\u6001
  </h3>
  <div style="line-height: 40px;">
...
<\/script>`,u.__sourceCodeTitle="SelectRwSwitch"}const le=b("\u4E2D\u6587"),ae=b("English"),K=F({__name:"SelectRwSwitchDemo",setup(u){const n=f("zh-CN");return(s,a)=>{const l=o("el-tag"),d=o("el-option"),r=o("fu-select-rw-switch");return B(),E(r,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=p=>n.value=p)},{read:i(()=>[n.value==="zh-CN"?(B(),E(l,{key:0,"disable-transitions":"",type:"danger"},{default:i(()=>[le]),_:1})):(B(),E(l,{key:1,"disable-transitions":""},{default:i(()=>[ae]),_:1}))]),default:i(()=>[t(d,{key:"zh-CN",label:"\u4E2D\u6587",value:"zh-CN"}),t(d,{key:"en-US",label:"English",value:"en-US"})]),_:1},8,["modelValue"])}}});typeof $=="function"&&$(K);var oe=h(K,[["__file","/home/runner/work/fit2cloud-ui-plus/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/SelectRwSwitchDemo.vue"]]);function U(u){u.__sourceCode=`<template>
