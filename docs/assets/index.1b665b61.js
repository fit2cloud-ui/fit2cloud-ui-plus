import{d as F,b as f,r as o,o as B,e as C,a as t,w as i,_ as E,f as w,t as y,g,c as h,l as k,F as D,j as b,u as O,k as q,p as G,i as H}from"./index.f9ea90fb.js";function A(u){u.__sourceCode=`<template>
...
<\/script>`,u.__sourceCodeTitle="\u57FA\u672C\u7528\u6CD5"}const J={style:{"line-height":"40px"}},z=F({__name:"BaseDemo",setup(u){const n=f(!1),s=f("\u5355\u51FB\u586B\u5199");function a(p){console.log(p)}function l(){n.value=!1}function d(){l()}function r(p){p.key==="Enter"&&l()}return(p,e)=>{const v=o("el-input"),m=o("fu-read-write-switch");return B(),C("div",J,[t(m,{data:s.value,modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=_=>n.value=_),onChange:a},{default:i(()=>[t(v,{modelValue:s.value,"onUpdate:modelValue":e[0]||(e[0]=_=>s.value=_),onBlur:d,onKeydown:r},null,8,["modelValue"])]),_:1},8,["data","modelValue"])])}}});typeof A=="function"&&A(z);var M=E(z,[["__file","/Users/wangdan/\u5DE5\u4F5C/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/BaseDemo.vue"]]);function V(u){u.__sourceCode=`<template>
  <div style="line-height: 40px;">
    <fu-read-write-switch>
      <!-- \u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9 v-slot:read -->
      <template #read>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="\u81EA\u5B9A\u4E49\u8BFB\u5199\u5185\u5BB9"}const P={style:{"line-height":"40px"}},Q=g(" \u81EA\u5B9A\u4E49\u5199\u5185\u5BB9: "),R=F({__name:"CustomContentDemo",setup(u){const n=f("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("el-input"),d=o("fu-read-write-switch");return B(),C("div",P,[t(d,null,{read:i(()=>[w("div",null,"\u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9: "+y(n.value),1)]),default:i(({read:r})=>[Q,t(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=p=>n.value=p),onBlur:r,style:{width:"200px"}},null,8,["modelValue","onBlur"])]),_:1})])}}});typeof V=="function"&&V(R);var X=E(R,[["__file","/Users/wangdan/\u5DE5\u4F5C/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/CustomContentDemo.vue"]]);function S(u){u.__sourceCode=`<template>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="InputRwSwitch"}const I=F({__name:"InputRwSwitchDemo",setup(u){const n=f("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("fu-input-rw-switch");return B(),h(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=d=>n.value=d),placeholder:"\u5355\u51FB\u586B\u5199"},null,8,["modelValue"])}}});typeof S=="function"&&S(I);var Y=E(I,[["__file","/Users/wangdan/\u5DE5\u4F5C/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/InputRwSwitchDemo.vue"]]);function x(u){u.__sourceCode=`<template>
  <h3>
    v-model + \u4E8B\u4EF6 \u63A7\u5236\u72B6\u6001
  </h3>
  <div style="line-height: 40px;">
...
<\/script>`,u.__sourceCodeTitle="SelectRwSwitch"}const le=g("\u4E2D\u6587"),ae=g("English"),K=F({__name:"SelectRwSwitchDemo",setup(u){const n=f("zh-CN");return(s,a)=>{const l=o("el-tag"),d=o("el-option"),r=o("fu-select-rw-switch");return B(),h(r,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=p=>n.value=p)},{read:i(()=>[n.value==="zh-CN"?(B(),h(l,{key:0,"disable-transitions":"",type:"danger"},{default:i(()=>[le]),_:1})):(B(),h(l,{key:1,"disable-transitions":""},{default:i(()=>[ae]),_:1}))]),default:i(()=>[t(d,{key:"zh-CN",label:"\u4E2D\u6587",value:"zh-CN"}),t(d,{key:"en-US",label:"English",value:"en-US"})]),_:1},8,["modelValue"])}}});typeof U=="function"&&U(K);var oe=E(K,[["__file","/Users/wangdan/\u5DE5\u4F5C/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/SelectRwSwitchDemo.vue"]]);function $(u){u.__sourceCode=`<template>
...
<\/script>`,u.__sourceCodeTitle="\u8868\u683C\u884C\u5185\u7F16\u8F91"}const ie=g("\u4E2D\u6587"),se=g("English"),j=F({__name:"TableInnerEditDemo",setup(u){const n=[{date:"2016-05-01",name:"\u5F20\u4E09",language:"zh-CN",address:"\u5317\u4EAC\u671D\u9633\u533A\u8D22\u5BCC\u4E2D\u5FC3 1\u5BA4"},{date:"2016-05-02",name:"\u5F20\u4E09",language:"en-US",address:"\u5317\u4EAC\u671D\u9633\u533A\u8D22\u5BCC\u4E2D\u5FC3 2\u5BA4"},{date:"2016-05-03",name:"\u5F20\u4E09",language:"zh-CN",address:"\u5317\u4EAC\u671D\u9633\u533A\u8D22\u5BCC\u4E2D\u5FC3 3\u5BA4"},{date:"2016-05-04",name:"\u5F20\u4E09",language:"en-US",address:"\u5317\u4EAC\u671D\u9633\u533A\u8D22\u5BCC\u4E2D\u5FC3 4\u5BA4"},{date:"2016-05-05",name:"\u5F20\u4E09",language:"zh-CN",address:"\u5317\u4EAC\u671D\u9633\u533A\u8D22\u5BCC\u4E2D\u5FC3 5\u5BA4"}];return(s,a)=>{const l=o("el-table-column"),d=o("el-tag"),r=o("el-option"),p=o("fu-select-rw-switch"),e=o("fu-input-rw-switch"),v=o("fu-table");return B(),h(v,{data:n},{default:i(()=>[t(l,{type:"selection"}),t(l,{prop:"name",label:"\u59D3\u540D","min-width":"180",fix:""}),t(l,{prop:"enable",label:"\u8BED\u8A00(\u53EF\u884C\u5185\u7F16\u8F91)"},{default:i(({row:m})=>[t(p,{modelValue:m.language,"onUpdate:modelValue":_=>m.language=_},{read:i(()=>[m.language==="zh-CN"?(B(),h(d,{key:0,"disable-transitions":"",type:"danger"},{default:i(()=>[ie]),_:1})):(B(),h(d,{key:1,"disable-transitions":""},{default:i(()=>[se]),_:1}))]),default:i(()=>[t(r,{key:"zh-CN",label:"\u4E2D\u6587",value:"zh-CN"}),t(r,{key:"en-US",label:"English",value:"en-US"})]),_:2},1032,["modelValue","onUpdate:modelValue"])]),_:1}),t(l,{prop:"address",label:"\u5730\u5740(\u53EF\u884C\u5185\u7F16\u8F91)"},{default:i(({row:m})=>[t(e,{modelValue:m.address,"onUpdate:modelValue":_=>m.address=_},null,8,["modelValue","onUpdate:modelValue"])]),_:1}),t(l,{prop:"date",label:"\u65E5\u671F","min-width":"180"})]),_:1})}}});typeof $=="function"&&$(j);var de=E(j,[["__file","/Users/wangdan/\u5DE5\u4F5C/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/TableInnerEditDemo.vue"]]);function N(u){u.__sourceCode=`<template>
  <div style="line-height: 40px;">
