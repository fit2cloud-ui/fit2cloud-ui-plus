import{d as h,b as _,r as o,o as B,e as C,a as t,w as i,_ as F,f as w,t as y,g,c as E,l as k,F as D,j as b,u as O,k as q,p as G,i as H}from"./index.b35308f8.js";function A(u){u.__sourceCode=`<template>
...
<\/script>`,u.__sourceCodeTitle="\u57FA\u672C\u7528\u6CD5"}const J={style:{"line-height":"40px"}},z=h({__name:"BaseDemo",setup(u){const n=_(!1),s=_("\u5355\u51FB\u586B\u5199");function a(p){console.log(p)}function l(){n.value=!1}function d(){l()}function r(p){p.key==="Enter"&&l()}return(p,e)=>{const v=o("el-input"),m=o("fu-read-write-switch");return B(),C("div",J,[t(m,{data:s.value,modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=f=>n.value=f),onChange:a},{default:i(()=>[t(v,{modelValue:s.value,"onUpdate:modelValue":e[0]||(e[0]=f=>s.value=f),onBlur:d,onKeydown:r},null,8,["modelValue"])]),_:1},8,["data","modelValue"])])}}});typeof A=="function"&&A(z);var M=F(z,[["__file","/Users/mokun/fit2cloud2.0/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/BaseDemo.vue"]]);function V(u){u.__sourceCode=`<template>
  <div style="line-height: 40px;">
    <fu-read-write-switch>
      <!-- \u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9 v-slot:read -->
      <template #read>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="\u81EA\u5B9A\u4E49\u8BFB\u5199\u5185\u5BB9"}const P={style:{"line-height":"40px"}},Q=g(" \u81EA\u5B9A\u4E49\u5199\u5185\u5BB9: "),R=h({__name:"CustomContentDemo",setup(u){const n=_("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("el-input"),d=o("fu-read-write-switch");return B(),C("div",P,[t(d,null,{read:i(()=>[w("div",null,"\u81EA\u5B9A\u4E49\u8BFB\u5185\u5BB9: "+y(n.value),1)]),default:i(({read:r})=>[Q,t(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=p=>n.value=p),onBlur:r,style:{width:"200px"}},null,8,["modelValue","onBlur"])]),_:1})])}}});typeof V=="function"&&V(R);var X=F(R,[["__file","/Users/mokun/fit2cloud2.0/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/CustomContentDemo.vue"]]);function S(u){u.__sourceCode=`<template>
...
import { ref } from "vue"
const input = ref("\u5355\u51FB\u586B\u5199")
<\/script>`,u.__sourceCodeTitle="InputRwSwitch"}const I=h({__name:"InputRwSwitchDemo",setup(u){const n=_("\u5355\u51FB\u586B\u5199");return(s,a)=>{const l=o("fu-input-rw-switch");return B(),E(l,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=d=>n.value=d),placeholder:"\u5355\u51FB\u586B\u5199"},null,8,["modelValue"])}}});typeof S=="function"&&S(I);var Y=F(I,[["__file","/Users/mokun/fit2cloud2.0/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/InputRwSwitchDemo.vue"]]);function x(u){u.__sourceCode=`<template>
  <h3>
    v-model + \u4E8B\u4EF6 \u63A7\u5236\u72B6\u6001
  </h3>
  <div style="line-height: 40px;">
...
<\/script>`,u.__sourceCodeTitle="\u8BFB\u72B6\u6001\u63A7\u5236"}const Z=w("h3",null," v-model + \u4E8B\u4EF6 \u63A7\u5236\u72B6\u6001 ",-1),ee={style:{"line-height":"40px"}},ue=w("h3",null," slot\u53C2\u6570 + \u4E8B\u4EF6 \u63A7\u5236\u72B6\u6001 ",-1),te={style:{"line-height":"40px"}},T=h({__name:"ReadSwitchDemo",setup(u){const n=_(!1),s=_("\u5355\u51FB\u586B\u5199");function a(){n.value=!1}function l(){a()}function d(p){p.key==="Enter"&&a()}function r(p,e){p.key==="Enter"&&e()}return(p,e)=>{const v=o("el-input"),m=o("fu-read-write-switch");return B(),C(D,null,[Z,w("div",ee,[t(m,{data:s.value,modelValue:n.value,"onUpdate:modelValue":e[1]||(e[1]=f=>n.value=f)},{default:i(()=>[t(v,{modelValue:s.value,"onUpdate:modelValue":e[0]||(e[0]=f=>s.value=f),onBlur:l,onKeydown:k(d,["native"])},null,8,["modelValue","onKeydown"])]),_:1},8,["data","modelValue"])]),ue,w("div",te,[t(m,{data:s.value},{default:i(({r:f})=>[t(v,{modelValue:s.value,"onUpdate:modelValue":e[2]||(e[2]=c=>s.value=c),onBlur:f,onKeydown:e[3]||(e[3]=k(c=>r(c,a),["native"]))},null,8,["modelValue","onBlur"])]),_:1},8,["data"])])],64)}}});typeof x=="function"&&x(T);var ne=F(T,[["__file","/Users/mokun/fit2cloud2.0/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/ReadSwitchDemo.vue"]]);function U(u){u.__sourceCode=`<template>
...
<\/script>`,u.__sourceCodeTitle="SelectRwSwitch"}const le=g("\u4E2D\u6587"),ae=g("English"),K=h({__name:"SelectRwSwitchDemo",setup(u){const n=_("zh-CN");return(s,a)=>{const l=o("el-tag"),d=o("el-option"),r=o("fu-select-rw-switch");return B(),E(r,{modelValue:n.value,"onUpdate:modelValue":a[0]||(a[0]=p=>n.value=p)},{read:i(()=>[n.value==="zh-CN"?(B(),E(l,{key:0,"disable-transitions":"",type:"danger"},{default:i(()=>[le]),_:1})):(B(),E(l,{key:1,"disable-transitions":""},{default:i(()=>[ae]),_:1}))]),default:i(()=>[t(d,{key:"zh-CN",label:"\u4E2D\u6587",value:"zh-CN"}),t(d,{key:"en-US",label:"English",value:"en-US"})]),_:1},8,["modelValue"])}}});typeof U=="function"&&U(K);var oe=F(K,[["__file","/Users/mokun/fit2cloud2.0/fit2cloud-ui-plus/examples/pages/read-write-switch/demo/SelectRwSwitchDemo.vue"]]);function $(u){u.__sourceCode=`<template>
